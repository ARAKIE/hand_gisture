...
navigator.mediaDevices.enumerateDevices().then((devices) => {
  ...
  draw_icon.src = "/static/draw.png";
  erase_icon.src = "/static/erase.png";
  ...
  // Define a variable to store the binary image data
  context.drawImage(video, 0, 0, canvas.width, canvas.height);
  // Draw rectangle
// define the drawRectangle function with parameters for width and height
  ...
  function processHands(results) {
    if (results.multiHandLandmarks) {
      for (const landmarks of results.multiHandLandmarks) {
        ...
        finger_state.index =
          landmarks[fingers.index1].y < landmarks[fingers.index3].y;
        finger_state.middle =
          landmarks[fingers.middle1].y < landmarks[fingers.middle3].y;
        finger_state.ring =
          landmarks[fingers.ring1].y < landmarks[fingers.ring3].y;
        finger_state.little =
          landmarks[fingers.little1].y < landmarks[fingers.little3].y;
      }
    }
  }
